...
def main():
    ...
    # Look for config in Docker path first, then local path
    ...
    print(
        json.dumps({"event": "training_start", "device": str(device)}),
        flush=True,
    )
    ...
    train_loader, val_loader = get_dataloaders(
        ...
        num_workers=0,  # Use 0 workers for Docker compatibility
    )
